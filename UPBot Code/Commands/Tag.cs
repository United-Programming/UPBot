...
[SlashCommandGroup("tags", "Define the tags on the server")]
public class SlashTagsEdit : ApplicationCommandModule {
  ...
  [SlashCommand("tagalias", "Define aliases for a tag, use without parameters to remove aliases")]
  public async Task TagAliasCommand(InteractionContext ctx, [Option("tagname", "Tag to be aliased")] string tagname, [Option("alias1", "First alias")] string alias1 = null, [Option("alias2", "Second alias")] string alias2 = null, [Option("alias3", "Third alias")] string alias3 = null) {
    Utils.LogUserCommand(ctx);
