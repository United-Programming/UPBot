...
public class Configs {
  private static readonly Dictionary<ulong, DiscordGuild> Guilds = new();
  public static readonly Dictionary<ulong, TrackChannel> TrackChannels = new();
  public static readonly Dictionary<ulong, List<ulong>> AdminRoles = new();
  public static readonly Dictionary<ulong, SpamProtection> SpamProtections = new();
  public static readonly Dictionary<ulong, List<TagBase>> Tags = new();
  public static readonly Dictionary<ulong, List<string>> SpamLinks = new();
  public static readonly Dictionary<ulong, List<string>> WhiteListLinks = new();

  public static readonly Dictionary<ulong, TempSetRole> TempRoleSelected = new();
  ...
  internal static void SetWeatherAPIKey(string key) {
    ...
    if (keys != null && keys.Count > 0) { // Remove the previous
